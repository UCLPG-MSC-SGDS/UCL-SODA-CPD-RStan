...
### Lectures (Length: 1:37:35)
```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('DdchRhSQpj0', height=400) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/DdchRhSQpj0)
...
### Demonstration [Part I] (Length: 1:55:54)
```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('W5hcGtGl04M', height=400) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/W5hcGtGl04M)

### Demonstration [Part II] (Length: 2:02:36)
```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_youtube('5YVkEBx-Dq8', height=400) %>% use_align('center')
```
[[**Watch on YouTube**]](https://youtu.be/5YVkEBx-Dq8)
