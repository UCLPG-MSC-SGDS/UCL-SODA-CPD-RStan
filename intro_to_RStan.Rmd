...
**Try this second problem in Stan**: The mean BMI value is 23 with SD of 1.2. Simulate sample of 1000 with BMI values based on this distribution `N(23, 2.6)` and perform Bayesian inference. 
...
<div class="note">
**Note:** Solutions will be made available next week as soon as **Day 2** materials are released
</div>
